...
class Projects extends Component {
  ...
  render(){
    let listedProjects_moblie = this.state.projects.map(project => {
      return (
        <Card>
    ...
    let listedProjects_website = this.state.projects.map((project) => {
        return (
          <Grid.Column width={5}>
